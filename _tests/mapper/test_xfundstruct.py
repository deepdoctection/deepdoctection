...
from deepdoctection.utils.object_types import CellType, LayoutType, ObjectTypes, TokenClasses, WordType
...
def test_xfund_to_image(
    ...
    assert sub_cats_category_names == [TokenClasses.OTHER, TokenClasses.OTHER, TokenClasses.HEADER]
