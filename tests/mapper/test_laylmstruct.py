...
def test_image_to_raw_layoutlm_features_for_token_data(datapoint_xfund: JsonDict,
                                                       ...
                                                       raw_layoutlm_features: JsonDict) -> None:
    """
...
@mark.requires_pt
def test_raw_features_to_layoutlm_features(dp_image_with_layout_and_word_annotations: Image,
                                           layoutlm_features: JsonDict) -> None:
    """
    testing image_to_layoutlm_features is mapping correctly
    """

    # Arrange
    dp = image_to_raw_layoutlm_features()(dp_image_with_layout_and_word_annotations)
