...
from deepdoctection.datapoint import BoundingBox, Image, ImageAnnotation, ContainerAnnotation
...
class TestTextOrderService:
    ...
    def test_integration_pipeline_component_wit_include_residual_text_container_to_false\
                    (dp_image_with_layout_and_word_annotations: Image) -> None:
        """
        ...
        residual_word_ann.dump_sub_category(WordType.characters,
                                            ContainerAnnotation(category_name=WordType.characters, value="residual"))
