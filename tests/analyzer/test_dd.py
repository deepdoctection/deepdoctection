...
def test_dd_analyzer_returns_meta_annotations() -> None:
    ...
    assert meta_annotations.sub_categories == {
        ...
        LayoutType.WORD: {
            WordType.CHARACTERS: {WordType.CHARACTERS},
            Relationships.READING_ORDER: {Relationships.READING_ORDER},
        },
        LayoutType.TEXT: {Relationships.READING_ORDER: {Relationships.READING_ORDER}},
        LayoutType.TITLE: {Relationships.READING_ORDER: {Relationships.READING_ORDER}},
        LayoutType.LIST: {Relationships.READING_ORDER: {Relationships.READING_ORDER}},
        LayoutType.KEY_VALUE_AREA: {Relationships.READING_ORDER: {Relationships.READING_ORDER}},
        LayoutType.LINE: {Relationships.READING_ORDER: {Relationships.READING_ORDER}},
    }
    assert meta_annotations.relationships == {
