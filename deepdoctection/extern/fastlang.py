...
FASTTEXT_GEO691_2 ={'__label__en':"eng",
 '__label__ru':"rus",
'__label__de':"deu",
'__label__fr':"fre",
'__label__it':"ita",
...
class FasttextLangDetector(LanguageDetector):
    ...
    [2] Joulin A, Grave E, Bojanowski P, Douze M, Jégou H, Mikolov T, FastText.zip: Compressing text classification models
    ...
    def predict(self, text_string: str) -> DetectionResult:
        ...
        return DetectionResult(text=FASTTEXT_GEO691_2[output[0][0]],
                               score=output[1][0])
