...
class Image:
    ...
    def remove(self, annotation_ids: Optional[Union[str,list[str]]]=None,
                     service_ids: Optional[Union[str,list[str]]]=None) -> None:
        """
    ...
    def _remove_by_annotation_id(self, annotation_id: str, location_dict: AnnotationMap):
        ...
        if ( location_dict.sub_category_key is None and
                ...
                location_dict.summary_key is None):
    ...
    def get_service_id_to_annotation_id(self):
