...
def test_dataset_doclaynet_returns_image(dataset_test_base_dir: str) -> None:
    """
    test dataset Doclaynet returns image
    """
...
def test_dataset_doclaynet_seq_returns_image(dataset_test_base_dir: str) -> None:
    """
