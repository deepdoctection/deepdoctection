...
@overload
def _get_dict(
    l: Sequence[ObjectTypes], name_as_key: Literal[True], starts_with: int = ...
) -> dict[ObjectTypes, int]: ...


@overload
def _get_dict(
    l: Sequence[ObjectTypes], name_as_key: Literal[False], starts_with: int = ...
) -> dict[int, ObjectTypes]: ...
