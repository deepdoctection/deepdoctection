...
from dd_datapoint.utils.transform import (
    InferenceResize,
    PadTransform,
    ResizeTransform,
    RotationTransform,
...
class TestBoxToPoint4:
    ...
    def test_box_to_point4_shape(boxes: np.ndarray, expected_shape: tuple) -> None:
...
class TestPoint4ToBox:
    ...
    def test_point4_to_box_shape(points: np.ndarray, expected_shape: tuple) -> None:
...
class TestResizeTransform:
    ...
    def test_resize_transform_apply_image(np_image: np.ndarray, h: int, w: int, new_h: int, new_w: int) -> None:
    ...
    def test_resize_transform_apply_coords(coords: np.ndarray, h: int, w: int, new_h: int, new_w: int) -> None:
...
class TestInferenceResize:
    ...
    def test_inference_resize_get_transform(np_image: np.ndarray, short_edge: int, max_size: int) -> None:
...
class TestNormalizeImage:
    ...
    def test_normalize_image(np_image: np.ndarray, pixel_mean: np.ndarray, pixel_std: np.ndarray) -> None:
        """Test normalize_image"""
...
class TestPadImage:
    ...
    def test_pad_image(np_image: np.ndarray, top: int, right: int, bottom: int, left: int) -> None:
        """Test pad_image"""
...
class TestPadTransform:
    ...
    def test_pad_transform_apply_image(np_image: np.ndarray, top: int, right: int, bottom: int, left: int) -> None:
    ...
    @staticmethod
    @pytest.mark.parametrize("top,right,bottom,left", [(10, 20, 10, 20)])
    def test_pad_transform_apply_coords(coords: np.ndarray, top: int, right: int, bottom: int, left: int) -> None:
...
class TestRotationTransform:
    ...
    def test_rotation_transform_apply_image(np_image: np.ndarray, angle: Literal[90, 180, 270]) -> None:
    ...
    def test_rotation_transform_apply_coords(coords: np.ndarray, angle: Literal[90, 180]) -> None:
