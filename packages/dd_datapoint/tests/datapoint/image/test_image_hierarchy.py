...
class TestImageHierarchy:
    ...
    def test_image_ann_to_image_creates_image_attribute(self, white_image: stu.WhiteImage):
    ...
    def test_image_ann_to_image_sets_correct_dimensions(self, white_image: stu.WhiteImage):
    ...
    def test_image_ann_to_image_creates_embedding(self, white_image: stu.WhiteImage):
    ...
    def test_image_ann_to_image_crop_image_creates_pixels(self, white_image: stu.WhiteImage):
    ...
    def test_image_ann_to_image_no_crop_leaves_no_pixels(self, white_image: stu.WhiteImage):
    ...
    def test_image_ann_to_image_requires_bbox(self, white_image: stu.WhiteImage):
    ...
    def test_image_ann_to_image_crop_requires_image_data(self, white_image: stu.WhiteImage):
    ...
    def test_remove_image_from_lower_hierarchy_removes_sub_images(self, white_image: stu.WhiteImage):
    ...
    def test_remove_image_from_lower_hierarchy_preserves_bbox(self, white_image: stu.WhiteImage):
    ...
    def test_remove_image_pixel_values_only(self, white_image: stu.WhiteImage):
    ...
    def test_get_categories_from_current_state(self, white_image: stu.WhiteImage):
    ...
    def test_get_categories_excludes_inactive(self, white_image: stu.WhiteImage):
