...
class TestTableViews:
    ...
    def test_tables_have_rows_property(self, page: Page):
    ...
    def test_tables_have_columns_property(self, page: Page):
    ...
    def test_table_row_method_returns_list(self, page: Page):
        """Table.row() returns a list of cells"""

        tables = page.tables
        for table in tables:
            row_cells = table.row(1)
            assert isinstance(row_cells, list)

    def test_table_column_method_returns_list(self, page: Page):
        """Table.column() returns a list of cells"""

        tables = page.tables
        for table in tables:
            col_cells = table.column(1)
            assert isinstance(col_cells, list)

    def test_table_column_header_cells_returns_list(self, page: Page):
    ...
    def test_table_csv_returns_list_of_lists(self, page: Page):
    ...
    def test_table_csv_underscore_returns_list_of_lists(self, page: Page):
    ...
    def test_table_str_returns_string(self, page: Page):
    ...
    def test_table_text_returns_string(self, page: Page):
    ...
    def test_table_words_returns_list(self, page: Page):
    ...
    def test_table_has_number_of_columns(self, page: Page):
