...
# Note: deepdoctection.dataflow is not part of dd_datapoint package
# Tests requiring dataflow are marked with skip
from dd_datapoint.datapoint import AnnotationMap, BoundingBox, CategoryAnnotation, Image, ImageAnnotation
...
class TestImage:
    ...
    def test_load_image_from_dict() -> None:
        ...
        """
        skip("Requires deepdoctection.dataflow package - move to integration tests")
        # df: DataFlow
    ...
    def test_remove_by_service_id(dp_image_with_layout_and_word_annotations: Image) -> None:
        ...
        # Assert
        anns = dp.get_annotation(service_ids="test_service")
        assert not anns
