...
class TestImageInitialization:
    ...
    def test_image_can_be_created_with_minimal_params(self):
    ...
    def test_image_with_location_and_filename(self):
    ...
    def test_image_with_external_id(self):
    ...
    def test_image_with_uuid_external_id(self):
    ...
    def test_image_document_id_defaults_to_image_id(self):
    ...
    def test_image_id_cannot_be_reassigned_once_set(self, image: WhiteImage):
