...
from dd_datapoint.datapoint import (
    BoundingBox,
    BoundingBoxError,
    crop_box_from_image,
    global_to_local_coords,
...
class TestIntersectionBox:
    ...
    def test_case_a_same_mode_absolute_overlapping(self):
        """
    ...
    def test_case_a_exact_overlap(self):
    ...
    def test_case_b_no_overlap_raises(self):
    ...
    def test_case_b_touching_boxes_zero_width(self):
    ...
    def test_case_b_touching_boxes_zero_height(self):
    ...
    def test_case_c_mixed_modes_without_dimensions_raises(self):
    ...
    def test_case_c_mixed_modes_with_dimensions(self):
        """
    ...
    def test_case_c_mixed_modes_reverse_order(self):
    ...
    def test_relative_coords_intersection(self):
...
class TestCropBoxFromImage:
    ...
    def test_absolute_crop_shape(self):
        """
    ...
    def test_absolute_crop_clamping_at_borders(self):
    ...
    def test_relative_crop_without_dimensions_raises(self):
    ...
    def test_relative_crop_with_dimensions(self):
        """
    ...
    def test_out_of_bounds_crop_clamped(self):
...
class TestLocalGlobalCoords:
    ...
    def test_local_to_global_happy_path(self):
        """
    ...
    def test_local_to_global_non_absolute_raises(self):
    ...
    def test_local_to_global_local_non_absolute_raises(self):
    ...
    def test_global_to_local_fully_inside(self):
        """
    ...
    def test_global_to_local_partially_outside_clipped(self):
        """
    ...
    def test_global_to_local_non_absolute_raises(self):
    ...
    def test_roundtrip_local_global_local(self):
...
class TestMergeBoxes:
    ...
    def test_merge_multiple_absolute_boxes(self):
    ...
    def test_merge_multiple_relative_boxes(self):
    ...
    def test_merge_mixed_modes_raises(self):
...
class TestRescaleCoords:
    ...
    def test_rescale_absolute_scale_up(self):
    ...
    def test_rescale_absolute_scale_down(self):
    ...
    def test_rescale_absolute_non_uniform(self):
    ...
    def test_rescale_relative_unchanged(self):
    ...
    def test_rescale_no_change(self):
...
class TestIntersectionBoxes:
    ...
    def test_empty_inputs_both_empty(self):
        """([], []) returns []."""
        result = intersection_boxes([], [])
        assert result == []

    def test_empty_inputs_first_empty(self):
        """([], B) returns B."""
        box1 = BoundingBox(absolute_coords=True, ulx=10, uly=10, lrx=20, lry=20)
        box2 = BoundingBox(absolute_coords=True, ulx=30, uly=30, lrx=40, lry=40)
    ...
    def test_empty_inputs_second_empty(self):
        """(A, []) returns A."""
        box1 = BoundingBox(absolute_coords=True, ulx=10, uly=10, lrx=20, lry=20)
        box2 = BoundingBox(absolute_coords=True, ulx=30, uly=30, lrx=40, lry=40)
    ...
    def test_pairwise_intersections_mixed_overlap(self):
        """
    ...
    def test_pairwise_intersections_all_overlap(self):
        """All pairs overlap."""
        boxes1 = [
    ...
    def test_pairwise_intersections_no_overlap(self):
        """No pairs overlap."""
        boxes1 = [
    ...
    def test_pairwise_exact_intersection_values(self):
        """
