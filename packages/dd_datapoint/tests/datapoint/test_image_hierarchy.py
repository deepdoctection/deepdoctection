...
class TestImageHierarchy:
    ...
    def test_image_ann_to_image_creates_image_attribute(self, image: WhiteImage):
    ...
    def test_image_ann_to_image_sets_correct_dimensions(self, image: WhiteImage):
    ...
    def test_image_ann_to_image_creates_embedding(self, image: WhiteImage):
    ...
    def test_image_ann_to_image_crop_image_creates_pixels(self, image: WhiteImage):
    ...
    def test_image_ann_to_image_no_crop_leaves_no_pixels(self, image: WhiteImage):
    ...
    def test_image_ann_to_image_requires_bbox(self, image: WhiteImage):
    ...
    def test_image_ann_to_image_crop_requires_image_data(self, image: WhiteImage):
    ...
    def test_remove_image_from_lower_hierarchy_removes_sub_images(self, image: WhiteImage):
    ...
    def test_remove_image_from_lower_hierarchy_preserves_bbox(self, image: WhiteImage):
    ...
    def test_remove_image_pixel_values_only(self, image: WhiteImage):
    ...
    def test_get_categories_from_current_state(self, image: WhiteImage):
    ...
    def test_get_categories_excludes_inactive(self, image: WhiteImage):
