...
class TestLayoutViews:
    ...
    def test_layouts_have_text_property(self, page: Page):
    ...
    def test_layouts_have_text_underscore_property(self, page: Page):
    ...
    def test_layout_get_ordered_words_returns_list(self, page: Page):
        """Layout.get_ordered_words() returns a list"""

        layouts = page.layouts
        if layouts:
            ordered_words = layouts[0].get_ordered_words()
            assert isinstance(ordered_words, list)

    def test_layout_get_ordered_words_has_reading_order(self, page: Page):
    ...
    def test_layout_len_returns_int(self, page: Page):
    ...
    def test_layout_len_equals_text_length(self, page: Page):
