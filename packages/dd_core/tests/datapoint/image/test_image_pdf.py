...
from dd_core.utils.file_utils import pdf_to_cairo_available, pdf_to_ppm_available, pypdfium2_available

from ..conftest import TestPdfPage

REQUIRES_PDFMIUM_OR_POPPLER = pytest.mark.skipif(
    not (pdf_to_cairo_available() or pdf_to_ppm_available() or pypdfium2_available()),
