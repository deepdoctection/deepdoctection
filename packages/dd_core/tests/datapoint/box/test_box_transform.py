...
class TestBBoxTransform:
    ...
    @pytest.mark.parametrize("ulx,uly,lrx,lry,img_w,img_h,exp_ulx,exp_uly,exp_lrx,exp_lry", [
        # Box at origin
    ...
    def test_abs_to_rel_expected_values(self, ulx, uly, lrx, lry, img_w, img_h, 
                                        exp_ulx, exp_uly, exp_lrx, exp_lry):
    ...
    def test_rel_to_abs_expected_values(self, ulx, uly, lrx, lry, img_w, img_h,
                                        exp_ulx, exp_uly, exp_lrx, exp_lry):
