...
class TestBBoxSetters:
    ...
    def test_set_width_updates_lrx_absolute(self) -> None:
    ...
    def test_set_height_updates_lry_absolute(self) -> None:
    ...
    def test_set_width_with_rounding_absolute(self) -> None:
    ...
    def test_set_height_with_rounding_absolute(self) -> None:
    ...
    def test_set_width_zero_rejected_absolute(self) -> None:
    ...
    def test_set_height_zero_rejected_absolute(self) -> None:
    ...
    def test_set_width_negative_rejected_absolute(self) -> None:
    ...
    def test_set_height_negative_rejected_absolute(self) -> None:
    ...
    def test_set_lrx_preserves_positive_width_absolute(self) -> None:
    ...
    def test_set_lry_preserves_positive_height_absolute(self) -> None:
    ...
    def test_set_ulx_preserves_positive_width_absolute(self) -> None:
    ...
    def test_set_uly_preserves_positive_height_absolute(self) -> None:
    ...
    def test_set_width_updates_lrx_relative(self) -> None:
    ...
    def test_set_height_updates_lry_relative(self) -> None:
    ...
    def test_set_width_zero_rejected_relative(self) -> None:
    ...
    def test_set_height_zero_rejected_relative(self) -> None:
    ...
    def test_set_width_negative_rejected_relative(self) -> None:
    ...
    def test_set_height_negative_rejected_relative(self) -> None:
    ...
    def test_set_lrx_preserves_positive_width_relative(self) -> None:
    ...
    def test_set_lry_preserves_positive_height_relative(self) -> None:
    ...
    def test_set_ulx_preserves_positive_width_relative(self) -> None:
    ...
    def test_set_uly_preserves_positive_height_relative(self) -> None:
    ...
    def test_setter_error_messages_contain_coords(self) -> None:
    ...
    def test_multiple_setter_operations_maintain_invariants(self) -> None:
