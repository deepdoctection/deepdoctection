...
class TestBBoxInitValidate:
    ...
    def test_constructor_requires_lrx_lry_or_width_height_absolute(self) -> None:
    ...
    def test_constructor_requires_lrx_lry_or_width_height_relative(self) -> None:
    ...
    def test_relative_coords_above_one_rejected(self) -> None:
    ...
    def test_zero_coordinate_is_valid_absolute(self) -> None:
    ...
    def test_zero_coordinate_is_valid_relative(self) -> None:
    ...
    def test_negative_ul_rejected_absolute(self) -> None:
    ...
    def test_rounding_absolute_coords(self, value: float, expected_rounded: int) -> None:
    ...
    def test_rounding_width_computation_absolute(self, width_val: float, expected_lrx: int) -> None:
    ...
    def test_rounding_relative_coords_internal_storage(self, rel_val: float, expected_int: int) -> None:
    ...
    def test_valid_minimal_absolute_box(self) -> None:
    ...
    def test_as_dict_roundtrip_absolute_width_height(self) -> None:
    ...
    def test_as_dict_roundtrip_absolute_lrx_lry(self) -> None:
    ...
    def test_as_dict_roundtrip_relative_width_height(self) -> None:
    ...
    def test_as_dict_roundtrip_relative_lrx_lry(self) -> None:
