...
"""
Tests for the conversion of `Image` objects into Detectron2-style data structures
for Faster-RCNN training.

This module contains unit tests for validating the functionality of the
`image_to_d2_frcnn_training` function from the `dd_core.mapper.d2struct` module.
The tests ensure compatibility with all categories or filtered categories such
as 'text'. It assumes the availability of Detectron2.

Tests will be skipped if Detectron2 is not installed.
"""
